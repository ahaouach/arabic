...
import type { AnimalWorldQuizSection } from "@/lib/lessonSections";

export default function AnimalWorldQuiz({
  section,
}: {
  section: AnimalWorldQuizSection;
}) {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-50 via-white to-emerald-50 p-6 shadow-lg ring-1 ring-black/5 sm:p-8">
