...
export interface ShapesLessonPageProps {
...
/**
 * Self-contained orchestrator for the `shapes_lesson` section.
 *
 * Phases: `intro` → `zone[0..N-1]` → `complete`. Mirrors the numbers /
 * colors lesson orchestrators so the lesson chrome (shell, score tracker,
 * confetti) stays consistent across every gamified Arabic course.
 */
    ...
    >
      <AnimatePresence mode="wait">
        {phase.kind === "intro" && (
          ...
          >
            <div className="mx-auto flex h-28 w-28 items-center justify-center rounded-full bg-gradient-to-br from-amber-300 via-rose-400 to-sky-500 text-6xl shadow-xl ring-4 ring-white">
              🔷
            </div>
            <h1
            ...
            <p
              ...
              style={{ fontFamily: '"Amiri", "Noto Naskh Arabic", serif' }}
            >
              هَيَّا بِنَا نَكْتَشِفُ الْأَشْكَالَ!
            </p>
            <motion.button
              type="button"
              onClick={start}
